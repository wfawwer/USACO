		 ...
		 while(unvisited.size()!=0){
			...
			if(currentX-1>=0){
				...
				if(alt<dist[currentX-1][currentY][newmove]){
					...
					unvisited.add(new state(currentX-1,currentY,newmove));
				}
			}
			//down//
			if(currentX+1<N){
			...
			if(currentY-1>=0){
				...
				if(alt<dist[currentX][currentY-1][newmove]){
					...
					unvisited.add(new state(currentX,currentY-1,newmove));
				}
			}
			//right//
			if(currentY+1<N){
